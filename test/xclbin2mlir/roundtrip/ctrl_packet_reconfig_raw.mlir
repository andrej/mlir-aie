// RUN: aie-translate --xclbin-to-mlir %S/../../npu-xrt/ctrl_packet_reconfig/aie.xclbin | FileCheck %s

// Round-trip verification test for xclbin decompilation in raw mode.
// This test decompiles the ctrl_packet_reconfig xclbin and verifies that the
...
// In raw mode, this should be represented as register write operations.
