...
// CHECK: aiex.npu.write32 {address = 1536 : ui32, column = 2 : i32, name = "rtp", row = 3 : i32, value = 50 : ui32}
// CHECK: aiex.npu.write32 {address = 3216 : ui32, column = 0 : i32, name = "RTP", row = 2 : i32, value = 99 : ui32}
