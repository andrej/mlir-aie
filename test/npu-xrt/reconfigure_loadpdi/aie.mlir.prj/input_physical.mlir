module {
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<512xi32>) {
      aiex.configure @add_two {
        ...
        aiex.run @add_two_sequence(%reinterpret_cast) : (memref<4xi32>)
        ...
        aiex.run @add_two_sequence(%reinterpret_cast_0) : (memref<4xi32>)
      }
      aiex.configure @add_three {
        %subview = memref.subview %arg0[4] [4] [1] : memref<512xi32> to memref<4xi32, strided<[1], offset: 4>>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [4], strides: [1] : memref<4xi32, strided<[1], offset: 4>> to memref<4xi32>
        aiex.run @add_three_sequence(%reinterpret_cast) : (memref<4xi32>)
        %subview_0 = memref.subview %arg0[12] [4] [1] : memref<512xi32> to memref<4xi32, strided<[1], offset: 12>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [4], strides: [1] : memref<4xi32, strided<[1], offset: 12>> to memref<4xi32>
        aiex.run @add_three_sequence(%reinterpret_cast_1) : (memref<4xi32>)
      }
    }
  }
  aie.device(npu2) @add_two {
    ...
    ^bb4:  // pred: ^bb3
      %4 = memref.load %objfifo_in_cons_buff_0[%2] : memref<4xi32>
      %5 = arith.addi %4, %c2_i32 : i32
      memref.store %5, %objfifo_out_buff_0[%2] : memref<4xi32>
    ...
    aie.runtime_sequence @add_two_sequence(%arg0: memref<4xi32>) {
      %0 = aiex.dma_configure_task_for @objfifo_in_shim_alloc {
        aie.dma_bd(%arg0 : memref<4xi32>, 0, 4)
        aie.end
      }
