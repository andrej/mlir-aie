module attributes {llvm.target_triple = "aie2p"} {
  llvm.mlir.global external @objfifo_in_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<4 x i32>
  llvm.mlir.global external @objfifo_out_buff_0() {addr_space = 0 : i32} : !llvm.array<4 x i32>
  ...
  ^bb4:  // pred: ^bb3
    %17 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<4 x i32>
    %18 = llvm.getelementptr inbounds|nuw %17[%15] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %19 = llvm.load %18 : !llvm.ptr -> i32
    %20 = llvm.add %19, %10 : i32
    %21 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<4 x i32>
