module {
  ...
  aie.device(npu2_1col) {
    memref.global "private" constant @config_blockwrite_data : memref<9xi32> = dense<[608, 0, 0, 0, 0, 0, 0, 0, 8]>
    memref.global "private" constant @config_blockwrite_data_0 : memref<135xi32> = dense<"">
    memref.global "private" constant @config_blockwrite_data_1 : memref<5xi32> = dense<[269621272, 271056920, 0, 0, 404226048]>
    memref.global "private" constant @config_blockwrite_data_2 : memref<5xi32> = dense<[269490200, 271056920, 0, 0, 29622272]>
    memref.global "private" constant @config_blockwrite_data_3 : memref<42xi32> = dense<[452, 289013768, 133120, -21319680, -939519686, -1342177279, 1105526643, 1948319440, 1883242884, -174555135, 1033375741, 4080, 472776704, 441909248, -1241513920, 2945026, 119283352, 0, 0, 0, 271581208, 467583224, 0, 0, 333506712, 1346371972, 32769, 0, 472776704, 441909248, -1241513920, 2945026, 133183768, 133550360, 134082840, 133929240, 0, 1572864, 29626408, -524288, 0, 0]>
    memref.global "private" constant @config_blockwrite_data_4 : memref<81xi32> = dense<[28858, 512, 2033909665, 1091071456, -83382272, 1776316418, -91312128, 1848668162, -66146304, 1781559298, -57757696, 839913786, -1342176828, -1043006066, 9097649, 1806725122, -32591872, 1785753602, -24203264, 741371906, 9580545, 137392130, -15814655, 450519288, 445800696, 1715438052, -1042018116, 323211429, 800092162, -7950336, 779120642, -49893376, -874483710, -75059199, 279445572, -1990721529, 1618878048, 989986859, 536871030, 2945024, 102538904, 115089048, 0, 0, 1075314688, 553127984, 7120, 0, 2013266145, 421, 536959744, 2945024, 324788248, 404201720, 0, 0, -1697613638, 538176002, 2025519879, -905930096, -91873263, 645496876, -2144535542, -57792655, 132968728, 133206296, 133476632, 133746968, 553156652, -2144534650, -49667728, 570130476, 29686670, -524288, 73875940, 1105462528, 660604773, 297500696, 276594712, 280657944, 284950552]>
    memref.global "private" constant @config_blockwrite_data_5 : memref<6xi32> = dense<[4195328, 0, 0, 0, 0, 100941792]>
    memref.global "private" constant @config_blockwrite_data_6 : memref<6xi32> = dense<[134218752, 1074266112, 0, 0, 0, 235167715]>
    memref.global "private" constant @config_blockwrite_data_7 : memref<8xi32> = dense<[1024, 655360, 0, 0, 0, 0, 0, -2126381248]>
    memref.global "private" constant @config_blockwrite_data_8 : memref<8xi32> = dense<[-2147482624, 1703936, 0, 0, 0, 0, 0, -2126446783]>
    memref.global "private" constant @config_blockwrite_data_9 : memref<8xi32> = dense<[-2130705408, 25853952, 0, 0, 0, 0, 0, -2126315709]>
    memref.global "private" constant @config_blockwrite_data_10 : memref<8xi32> = dense<[1024, 26902528, 0, 0, 0, 0, 0, -2126250174]>
    ...
    aie.runtime_sequence @run(%arg0: memref<64x64xi8>, %arg1: memref<64x64xi8>) {
      ...
      %0 = memref.get_global @config_blockwrite_data : memref<9xi32>
      aiex.control_packet {address = 2102272 : ui32, data = array<i32: 608, 0, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2102288 : ui32, data = array<i32: 0, 0, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2102304 : ui32, data = array<i32: 8>, opcode = 0 : i32, stream_id = 0 : i32}
      %1 = memref.get_global @config_blockwrite_data_0 : memref<135xi32>
      aiex.control_packet {address = 2228224 : ui32, data = array<i32: 165675076, 4456455, 1056, 136314948>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228240 : ui32, data = array<i32: 127401984, 25432609, -2147467200, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228256 : ui32, data = array<i32: 0, 1924792320, -1962858416, 2946944>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228272 : ui32, data = array<i32: 268435681, -51202, 536959807, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228288 : ui32, data = array<i32: -717651500, 57219, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228304 : ui32, data = array<i32: 1572864, 4144, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228320 : ui32, data = array<i32: 312510616, 541065604, 32768, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228336 : ui32, data = array<i32: 0, 709914870, 547130112, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228352 : ui32, data = array<i32: 1879048452, 0, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228368 : ui32, data = array<i32: -2013265660, 12058625, 6240, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228384 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228400 : ui32, data = array<i32: 0, 0, 0, 268959768>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228416 : ui32, data = array<i32: 0, 0, 0, 92056>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228432 : ui32, data = array<i32: 1744830596, 0, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228448 : ui32, data = array<i32: 28858, 512, 1033437153, 17043452>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228464 : ui32, data = array<i32: 69632, 268485912, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228480 : ui32, data = array<i32: 16570, 68, -921108511, 4096>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228496 : ui32, data = array<i32: 0, 11370806, 536870912, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228512 : ui32, data = array<i32: 2024804538, 0, -2143025168, 1763>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228528 : ui32, data = array<i32: 13107268, 280625159, 31502336, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228544 : ui32, data = array<i32: 268435681, 77992, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228560 : ui32, data = array<i32: 1342437932, 965, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228576 : ui32, data = array<i32: 2013266145, 421, 536959744, 600367104>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228592 : ui32, data = array<i32: 2013266145, 563610021, 536959779, 63262720>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228608 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228624 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228640 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228656 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228672 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228688 : ui32, data = array<i32: 337682456, 18761496, 342111000, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228704 : ui32, data = array<i32: 1085931520, 4718592, 2162688, 268484888>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228720 : ui32, data = array<i32: 0, 2126118912, 268435877, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228736 : ui32, data = array<i32: 536975916, 8716167, 73728, 268567832>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228752 : ui32, data = array<i32: 452, 65528, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      %2 = memref.get_global @config_blockwrite_data_1 : memref<5xi32>
      aiex.control_packet {address = 2228768 : ui32, data = array<i32: 269621272, 271056920, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228784 : ui32, data = array<i32: 404226048>, opcode = 0 : i32, stream_id = 0 : i32}
      %3 = memref.get_global @config_blockwrite_data_2 : memref<5xi32>
      aiex.control_packet {address = 2228800 : ui32, data = array<i32: 269490200, 271056920, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228816 : ui32, data = array<i32: 29622272>, opcode = 0 : i32, stream_id = 0 : i32}
      %4 = memref.get_global @config_blockwrite_data_3 : memref<42xi32>
      aiex.control_packet {address = 2228832 : ui32, data = array<i32: 452, 289013768, 133120, -21319680>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228848 : ui32, data = array<i32: -939519686, -1342177279, 1105526643, 1948319440>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228864 : ui32, data = array<i32: 1883242884, -174555135, 1033375741, 4080>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228880 : ui32, data = array<i32: 472776704, 441909248, -1241513920, 2945026>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228896 : ui32, data = array<i32: 119283352, 0, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228912 : ui32, data = array<i32: 271581208, 467583224, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228928 : ui32, data = array<i32: 333506712, 1346371972, 32769, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228944 : ui32, data = array<i32: 472776704, 441909248, -1241513920, 2945026>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228960 : ui32, data = array<i32: 133183768, 133550360, 134082840, 133929240>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228976 : ui32, data = array<i32: 0, 1572864, 29626408, -524288>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2228992 : ui32, data = array<i32: 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      %5 = memref.get_global @config_blockwrite_data_4 : memref<81xi32>
      aiex.control_packet {address = 2229008 : ui32, data = array<i32: 28858, 512, 2033909665, 1091071456>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229024 : ui32, data = array<i32: -83382272, 1776316418, -91312128, 1848668162>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229040 : ui32, data = array<i32: -66146304, 1781559298, -57757696, 839913786>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229056 : ui32, data = array<i32: -1342176828, -1043006066, 9097649, 1806725122>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229072 : ui32, data = array<i32: -32591872, 1785753602, -24203264, 741371906>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229088 : ui32, data = array<i32: 9580545, 137392130, -15814655, 450519288>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229104 : ui32, data = array<i32: 445800696, 1715438052, -1042018116, 323211429>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229120 : ui32, data = array<i32: 800092162, -7950336, 779120642, -49893376>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229136 : ui32, data = array<i32: -874483710, -75059199, 279445572, -1990721529>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229152 : ui32, data = array<i32: 1618878048, 989986859, 536871030, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229168 : ui32, data = array<i32: 102538904, 115089048, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229184 : ui32, data = array<i32: 1075314688, 553127984, 7120, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229200 : ui32, data = array<i32: 2013266145, 421, 536959744, 2945024>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229216 : ui32, data = array<i32: 324788248, 404201720, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229232 : ui32, data = array<i32: -1697613638, 538176002, 2025519879, -905930096>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229248 : ui32, data = array<i32: -91873263, 645496876, -2144535542, -57792655>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229264 : ui32, data = array<i32: 132968728, 133206296, 133476632, 133746968>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229280 : ui32, data = array<i32: 553156652, -2144534650, -49667728, 570130476>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229296 : ui32, data = array<i32: 29686670, -524288, 73875940, 1105462528>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229312 : ui32, data = array<i32: 660604773, 297500696, 276594712, 280657944>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 2229328 : ui32, data = array<i32: 284950552>, opcode = 0 : i32, stream_id = 0 : i32}
      ...
      %6 = memref.get_global @config_blockwrite_data_5 : memref<6xi32>
      ...
      %7 = memref.get_global @config_blockwrite_data_6 : memref<6xi32>
      aiex.control_packet {address = 2215968 : ui32, data = array<i32: 134218752, 1074266112, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      ...
      %8 = memref.get_global @config_blockwrite_data_7 : memref<8xi32>
      ...
      %9 = memref.get_global @config_blockwrite_data_8 : memref<8xi32>
      ...
      %10 = memref.get_global @config_blockwrite_data_9 : memref<8xi32>
      aiex.control_packet {address = 1704704 : ui32, data = array<i32: -2130705408, 25853952, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1704720 : ui32, data = array<i32: 0, 0, 0, -2126315709>, opcode = 0 : i32, stream_id = 0 : i32}
      %11 = memref.get_global @config_blockwrite_data_10 : memref<8xi32>
      aiex.control_packet {address = 1704736 : ui32, data = array<i32: 1024, 26902528, 0, 0>, opcode = 0 : i32, stream_id = 0 : i32}
