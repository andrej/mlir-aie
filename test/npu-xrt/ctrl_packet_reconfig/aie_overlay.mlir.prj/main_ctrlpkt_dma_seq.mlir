module {
  ...
  aie.device(npu2_1col) {
    ...
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[15, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[203, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_3 : memref<8xi32> = dense<[9, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_4 : memref<8xi32> = dense<[64, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_5 : memref<8xi32> = dense<[123, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_6 : memref<8xi32> = dense<[10, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_7 : memref<8xi32> = dense<[12, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_8 : memref<8xi32> = dense<[1024, 0, 1075314688, 16777216, -1006632945, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_9 : memref<8xi32> = dense<[1024, 0, 0, 16777216, -1006632945, 33554432, 0, 33554432]>
    aie.runtime_sequence @run(%arg0: memref<64x64xi8>, %arg1: memref<64x64xi8>, %arg2: memref<?xi32>) {
      ...
      %2 = memref.get_global @config_blockwrite_data_0 : memref<135xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %4 = memref.get_global @config_blockwrite_data_1 : memref<5xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %6 = memref.get_global @config_blockwrite_data_2 : memref<5xi32>
      %7 = memref.get_global @blockwrite_data_3 : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %8 = memref.get_global @config_blockwrite_data_3 : memref<42xi32>
      %9 = memref.get_global @blockwrite_data_4 : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %10 = memref.get_global @config_blockwrite_data_4 : memref<81xi32>
      %11 = memref.get_global @blockwrite_data_5 : memref<8xi32>
      ...
      %12 = memref.get_global @config_blockwrite_data_5 : memref<6xi32>
      %13 = memref.get_global @blockwrite_data_6 : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %14 = memref.get_global @config_blockwrite_data_6 : memref<6xi32>
      %15 = memref.get_global @blockwrite_data_6 : memref<8xi32>
      ...
      %16 = memref.get_global @config_blockwrite_data_7 : memref<8xi32>
      %17 = memref.get_global @blockwrite_data_7 : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %18 = memref.get_global @config_blockwrite_data_8 : memref<8xi32>
      %19 = memref.get_global @blockwrite_data_7 : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %20 = memref.get_global @config_blockwrite_data_9 : memref<8xi32>
      %21 = memref.get_global @blockwrite_data_7 : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119316 : ui32, value = 2147483648 : ui32}
      aiex.npu.sync {channel = 0 : i32, column = 0 : i32, column_num = 1 : i32, direction = 1 : i32, row = 0 : i32, row_num = 1 : i32}
      %22 = memref.get_global @config_blockwrite_data_10 : memref<8xi32>
      %23 = memref.get_global @blockwrite_data_7 : memref<8xi32>
      ...
      %24 = memref.get_global @blockwrite_data_8 : memref<8xi32>
      ...
      %25 = memref.get_global @blockwrite_data_9 : memref<8xi32>
