module {
  aie.device(npu1_1col) @xclbin_device {
    ...
    %bd_buf_0_2_3 = aie.buffer(%tile_0_2) {address = 0 : i32, sym_name = "bd_buf_0_2_3"} : memref<1xi32> 
    %bd_buf_0_2_2 = aie.buffer(%tile_0_2) {address = 4 : i32, sym_name = "bd_buf_0_2_2"} : memref<1xi32> 
    %bd_buf_0_2_1 = aie.buffer(%tile_0_2) {address = 8 : i32, sym_name = "bd_buf_0_2_1"} : memref<1xi32> 
    %bd_buf_0_2_0 = aie.buffer(%tile_0_2) {address = 12 : i32, sym_name = "bd_buf_0_2_0"} : memref<1xi32> 
