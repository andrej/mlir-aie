...
# common need to be imported after the above because they may emit
...
def main():
    argparser = common.get_default_argparser(256, 256, 256)
    args = argparser.parse_args()
    my_matmul(args.M, args.K, args.N, args.trace)


def my_matmul(M, K, N, trace_size):
    m = 64
    k = 64
    n = 64
    r = 4
