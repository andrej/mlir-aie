...
module {
  ...
  aie.device(npu1_1col) {
    ...
    aie.configuration @add_one (%shim_tile : index, %compute_tile : index) {
      aie.objectfifo @objFifo_in(%shim_tile, {%compute_tile}, 2 : i32) : !aie.objectfifo<memref<16xi32>>
      aie.objectfifo @objFifo_out(%compute_tile, {%shim_tile}, 2 : i32) : !aie.objectfifo<memref<8xi32>>
    ...
    aiex.runtime_sequence @add_one_rt (%in : memref<64xi32>, %out : memref<64xi32>) {
    ...
    aiex.runtime_sequence @main (%in: memref<64xi32>, %out: memref<64xi32>) {
      aiex.configure @add_one (%t00, %t02)
      aiex.run @add_one_rt (%in, %out)
    }
